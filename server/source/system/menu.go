...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	entities := []SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: true, ParentId: "3", Path: "menu", Name: "menu", Component: "view/superAdmin/menu/menu.vue", Sort: 2, Meta: Meta{Title: "菜单管理", Icon: "tickets", KeepAlive: true}},
		{MenuLevel: 0, Hidden: false, ParentId: "3", Path: "component", Name: "component", Component: "view/superAdmin/api/component.vue", Sort: 3, Meta: Meta{Title: "helm集群管理", Icon: "platform", KeepAlive: true}},
		...
		{MenuLevel: 0, Hidden: true, ParentId: "3", Path: "dictionary", Name: "dictionary", Component: "view/superAdmin/dictionary/sysDictionary.vue", Sort: 5, Meta: Meta{Title: "字典管理", Icon: "notebook"}},
		{MenuLevel: 0, Hidden: true, ParentId: "3", Path: "operation", Name: "operation", Component: "view/superAdmin/operation/sysOperationRecord.vue", Sort: 6, Meta: Meta{Title: "操作历史", Icon: "pie-chart"}},
		...
		{MenuLevel: 0, Hidden: true, ParentId: "0", Path: "state", Name: "state", Component: "view/system/state.vue", Sort: 8, Meta: Meta{Title: "服务器状态", Icon: "cloudy"}},
		...
		{MenuLevel: 0, Hidden: false, ParentId: "3", Path: "cluster", Name: "cluster", Component: "view/superAdmin/api/cluster.vue", Sort: 3, Meta: Meta{Title: "cluster管理", Icon: "platform", KeepAlive: true}},
		{MenuLevel: 0, Hidden: false, ParentId: "3", Path: "chart", Name: "chart", Component: "view/superAdmin/api/chart.vue", Sort: 3, Meta: Meta{Title: "chart管理", Icon: "platform", KeepAlive: true}},
	}
