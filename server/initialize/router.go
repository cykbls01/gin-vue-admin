...
func Routers() *gin.Engine {
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		systemRouter.InitClusterRouter(PrivateGroup, PublicGroup)
		systemRouter.InitComponentRouter(PrivateGroup, PublicGroup)
		systemRouter.InitChartRouter(PrivateGroup, PublicGroup)
